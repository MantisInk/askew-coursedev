...
public class RagdollModel extends ComplexObstacle {
	...
	protected boolean createJoints(World world) {
		...
		jointDef.localAnchorA.set(new Vector2(ARM_XOFFSET/2, TORSO_OFFSET/2));
		jointDef.localAnchorB.set(new Vector2(ARM_XOFFSET/2,0));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);
		...
		jointDef.localAnchorA.set(new Vector2(-THIGH_XOFFSET/2, -THIGH_YOFFSET/2));
		jointDef.localAnchorB.set(new Vector2(THIGH_XOFFSET/2,THIGH_YOFFSET/2));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);

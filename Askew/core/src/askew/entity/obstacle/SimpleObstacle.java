...
public abstract class SimpleObstacle extends Obstacle {
	 ...
	 * no collision response. This is done by using sensors. A sensor is an askew.entity that
	...
	public void draw(GameCanvas canvas, Color tint) {
		if (texture != null) {
			canvas.draw(texture,tint,origin.x,origin.y,getX()*drawScale.x,getY()*drawScale.x,getAngle(),100,100);
		}
	}

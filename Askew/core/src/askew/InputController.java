...
import askew.util.XBox360Controller;
...
public class InputController {
     ...
     */
    public boolean didTopDPadPress() {
        return topDPadPressed && !topDPadPrevious;
    }

    public boolean didLeftDPadPress() {
        return rightDPadPressed && !rightDPadPrevious;
    }

    public boolean didRightDPadPress() {
        return leftDPadPressed && !leftDPadPrevious;
    }

    public boolean didBottomDPadPress() {
        return bottomDPadPressed && !bottomDPadPrevious;
    }
    ...
    public boolean didLeftDrag() {
        return leftClickPressed && leftClickPrevious;
    }

    public boolean didLeftRelease() {
        return !leftClickPressed && leftClickPrevious;
    }

    public boolean didRightClick() {
        return rightClickPressed && !leftClickPrevious;
    }

    public boolean didRightDrag() {
        return rightClickPressed && rightClickPrevious;
    }

    public boolean didRightRelease() {
        return !rightClickPressed && rightClickPrevious;
    }

    public boolean didUpArrowPress() {
        return upKeyPressed && !upKeyPrevious;
    }
    ...
    public boolean didDownArrowPress() {
        return downKeyPressed && !downKeyPrevious;
    }
